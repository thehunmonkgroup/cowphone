--[[
  Records a sound file, then converts the speech to text, then the text to a
  cowsay, then emails the cowsay to the configured email address

  The recording is limited to 10 seconds.
]]

file_to_translate = "mailcow.wav"
